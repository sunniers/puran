 ...
 * 各种详细信息dao层
 */
public interface IDetailedInformationDao {
     ...
     * @throws Exception
     */
    public UserCreativeTalent selectUserCreativeTalent(Long creativeTalentId) throws Exception;
   /**
    * 查询项目名
    ...
    */
     ...
     * @return
     */
    public int insertProjectUserReleation (ProjectUserReleation projectUserReleation) throws Exception;
