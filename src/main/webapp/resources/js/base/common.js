T=(function(){
	return {
		...
		load:function(dom,url,data,func){
			if(url.indexOf('.html')!=-1){
				$.ajax({
		            ...
		            contentType:'application/json;charset=utf-8'
		        		...
		        		$(dom).empty();
		        		$(dom).append(xhr.responseText);
		        		/*if(xhr.getResponseHeader('urlType')=='front'){
							$(dom).load('../resources/html/front/userLogin.html');
						}else if(xhr.getResponseHeader('urlType')=='back'){
